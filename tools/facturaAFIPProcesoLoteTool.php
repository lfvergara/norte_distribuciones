...
class FacturaAFIPProcesoLoteTool {
    ...
    public function facturarProcesoLoteAFIP($obj_configuracion, $obj_tipofactura, $obj_egreso, $egresodetalle_collection) { 
        ...
        /* **************************************************************************************************************** */
        $punto_venta = $array_final1['punto_venta'];
        $numero_factura = $array_final1['nueva_factura'];
        $tipofactura = $array_final1['tipofactura_afip_id'];
        $fecha_factura = date('Ymd');
        $importe_total = $array_final1['importe_total'];
        $documentotipo_cliente = $array_final1['documentotipo_cliente'];
        $documento_cliente = $array_final1['documento_cliente'];
        $importe_nogravado = $array_final1['importe_nogravado'];
        $importe_exento = $array_final1['importe_exento'];
        $importe_neto = $array_final1['importe_neto'];
        $importe_iva = $array_final1['importe_iva'];
        $array_alicuotas = $array_final1['array_alicuotas'];
