...
class ClienteController {
	...
	function guardar() {
		...
		$this->model->dias_vencimiento_cuenta_corriente = (is_null($dias_vencimiento_cuenta_corriente) OR empty($dias_vencimiento_cuenta_corriente)) ? 1 : $dias_vencimiento_cuenta_corriente;
		$this->model->oculto = 0;
